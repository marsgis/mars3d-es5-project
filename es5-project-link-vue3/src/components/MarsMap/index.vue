...
const initMars3d = (option: any) => {
  ...
  // widget处理
  mars3d.Resource.fetchJson({ url: props.widgetUrl }).then((widgetJson: any) => {
    mars3d.widget.init(mapviewer, widgetJson, window.basePathUrl || '/') // basePathUrl定义在public/index.html
  })
